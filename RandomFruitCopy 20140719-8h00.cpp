...
public:
    ...
    Fruit randomFruitSelection(Fruit xFruit)
    {
        Fruit fruit = xFruit;
        int offset = fruit.getFruitMin();
        int range = fruit.getFruitWeight();
        ...
        {
            if (random >= fruitBasket.getFruitInBasket(i).getFruitMin && random <= fruitBasket.getFruitInBasket(i).getFruitMin + fruitBasket.getFruitInBasket(i).getFruitWeight - 1)
            {
